...
public class GyroAutocorrectCommand extends CommandBase {
    ...
    @Override
    public void execute() {
        SwerveModuleState frontLeftState = new SwerveModuleState(0.1, Rotation2d.fromDegrees(0));
        SwerveModuleState frontRightState = new SwerveModuleState(0.1, Rotation2d.fromDegrees(0));
        SwerveModuleState backLeftState = new SwerveModuleState(0.1, Rotation2d.fromDegrees(0));
        SwerveModuleState backRightState = new SwerveModuleState(0.1, Rotation2d.fromDegrees(0));
